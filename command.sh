...
#     --outdir /data/scratch/LAB/temp_demultiplex/20241219_example \
#     -resume
...
nextflow run main.nf \
    ...
    --outdir /data/scratch/LAB/temp_demultiplex/nfcore_demultiplex/sgalera/nfcore_demultiplex/test_new_dragen \
    -resume
